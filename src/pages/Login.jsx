    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-5">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl">
          ...
          {/* Error Message */}
          {err && (
            <div className="mb-4 text-sm text-red-600 bg-red-50 p-3 rounded-2xl">
              {err}
            </div>
          )}
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <input
              ...
              className="w-full border rounded-2xl px-4 py-3.5 text-sm focus:outline-none focus:border-emerald-500"
            />
            <input
              type="password"
              value={pass}
            ...
            <button
              type="submit"
              className="w-full py-3.5 rounded-2xl bg-zinc-900 text-white font-semibold active:bg-black transition"
            >
              Sign In
            </button>
          </form>
          ...
          {/* Recommended: Work Wallet */}
          <Link
            to="/"
            className="block w-full text-center py-3.5 rounded-2xl border font-medium hover:bg-zinc-50 transition"
          >
            Continue with Work Wallet <span className="text-emerald-600">(Recommended)</span>
          </Link>
